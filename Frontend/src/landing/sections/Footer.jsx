...
const WINDOWS_EXE_URL = 'https://github.com/msbillings/Restaurant-billing/releases/latest/download/MS-Billings-Setup-6.0.84.exe';
...
const MACOS_DMG_URL = 'https://github.com/msbillings/Restaurant-billing/releases/latest/download/MS-Billings-6.0.84.dmg';
        ...
        <div className="f-downloads">
          ...
          <div className="f-downloads__grid">
            ...
            <DownloadBtn
              icon={Apple}
              title="macOS"
              subtitle=".dmg · v6.0.84 · Universal"
              url={MACOS_DMG_URL}
            />
