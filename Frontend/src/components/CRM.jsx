    ...
    <div className="h-full flex flex-col bg-background p-4 sm:p-6 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4 shrink-0">
        <h1 className="text-2xl font-black text-text-main flex items-center gap-2">
          <Users className="text-primary" />{t("CUSTOMER DIRECTORY (CRM)")}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 shrink-0">
        <div className="bg-surface p-4 rounded-2xl border border-border flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-text-muted font-bold">{t("Total Customers")}</p>
        ...
        <div className="bg-surface p-4 rounded-2xl border border-border flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-text-muted font-bold">{t("VIP Members")}</p>
        ...
        <div className="bg-surface p-4 rounded-2xl border border-border flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-text-muted font-bold">{t("Total Revenue")}</p>
        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-background/50 sticky top-0 backdrop-blur-sm z-10">
            <tr>
              ...
              <th className="p-4 text-xs font-bold text-text-muted uppercase tracking-wider border-b border-border hidden sm:table-cell">{t("Contact")}</th>
              ...
              <th className="p-4 text-xs font-bold text-text-muted uppercase tracking-wider border-b border-border hidden md:table-cell">{t("Last Visit")}</th>
              <th className="p-4 text-xs font-bold text-text-muted uppercase tracking-wider border-b border-border hidden lg:table-cell">{t("Favorites")}</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border">
            ...
            <tr>
                <td colSpan="6" className="p-8 text-center text-text-muted font-medium">{t("No customers found.")}</td>
              </tr>
            }
          </tbody>
        </table>
