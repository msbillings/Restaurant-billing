        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
              <HelpCircle className="text-primary" />{t("Help & Support")}
            </h1>
            <p className="text-sm text-gray-500">{t("Access guides, FAQs, and contact support")}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto pb-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
            ...
            <h3 className="font-bold text-gray-800 mb-1">{t("24/7 Phone Support")}</h3>
            <p className="text-sm text-gray-500 mb-4">{t("Call us anytime for urgent POS issues.")}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
            ...
            <h3 className="font-bold text-gray-800 mb-1">{t("WhatsApp Chat")}</h3>
            <p className="text-sm text-gray-500 mb-4">{t("Chat directly with a support agent.")}</p>
            <a
              href="https://wa.me/919701800140?text=Hello%20msbillings%20support%2C%20I%20need%20help%20with%20my%20POS%20system."
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-bold transition-colors inline-block">{t("Start Chat")}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex items-center gap-4 cursor-pointer hover:border-primary transition-colors">
            ...
            <div>
              <div className="font-bold text-gray-800">{t("Email Support")}</div>
              <div className="text-sm text-gray-500">{t("support@billingpos.com")}</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-6 flex items-center gap-2">
              <BookOpen className="text-primary" size={20} />{t("Video Tutorials")}
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-video bg-gray-100 rounded-lg flex flex-col items-center justify-center text-gray-400 border border-gray-200 hover:border-primary cursor-pointer transition-colors">
                ...
                <span className="text-sm font-bold">{t("Billing Basics")}</span>
              </div>
              <div className="aspect-video bg-gray-100 rounded-lg flex flex-col items-center justify-center text-gray-400 border border-gray-200 hover:border-primary cursor-pointer transition-colors">
                <MonitorPlay size={32} className="mb-2" />
                <span className="text-sm font-bold">{t("Inventory Setup")}</span>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-6">{t("Frequently Asked Questions")}</h3>
