        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                <th className="px-6 py-4 text-sm font-semibold text-gray-600">Discount Name</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {discounts.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-6 py-8 text-center text-gray-500">No discounts configured yet.</td>
                </tr>
              ) : (
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Discount Name (e.g. SUMMER20 or Staff 10%)</label>
                <input 
                  type="text" required
                  value={formData.name}
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                />
                <label htmlFor="isActive" className="text-sm font-medium text-gray-700 cursor-pointer">Discount is currently active</label>
              </div>
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button type="submit" className="flex-1 py-3 text-white bg-primary hover:bg-primary-hover rounded-xl font-medium shadow-lg shadow-primary/30 transition-all">Save Discount</button>
              </div>
            </form>
          </div>
        </div>
