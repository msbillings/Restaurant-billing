      ...
      >
        <div className="flex justify-between items-start mb-3 sm:mb-4">
          ...
          <span className={`px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-bold uppercase tracking-wider ${
            isOccupied ? `bg-${statusColor}-100 text-${statusColor}-700` : 'bg-emerald-100 text-emerald-700'
          }`}>
            {statusText}
          </span>
        </div>
        ...
        <div>
          ...
          {isOccupied ? (
            <div className={`flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-${statusColor}-700 font-semibold`}>
