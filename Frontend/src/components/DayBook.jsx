        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 relative z-10">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              ...
              className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border transition-all font-bold text-xs sm:text-sm cursor-pointer relative overflow-hidden ${
                sendingWhatsApp
              ...
              {sendingWhatsApp ? (
                <>
                  ...
                  <div className="relative flex items-center justify-center shrink-0 w-4 h-4 z-10">
                    <Loader2 size={18} className="animate-spin text-[#25D366] absolute -inset-0.5" />
                    <svg className="w-2.5 h-2.5 fill-[#25D366] animate-pulse z-10" viewBox="0 0 24 24">
