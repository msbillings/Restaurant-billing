      ...
      <div className="flex items-center gap-2 p-3 border-b border-gray-100 bg-white">
        <div className="flex items-center gap-1.5">
          <div onClick={handleTableClick} className="flex flex-col items-center justify-center w-12 h-12 bg-red-50 border border-red-100 rounded-xl text-red-600 overflow-hidden px-1 shadow-sm cursor-pointer hover:bg-red-100 transition-colors">
            <span className="text-[9px] font-bold opacity-80 leading-tight">TABLE</span>
        ...
        <div className="flex-1 flex justify-end">
          {activeTable ? (
            <div className="flex flex-col items-end mr-2">
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Current Table</span>
              <span className="text-[13px] font-black text-gray-700 truncate max-w-[180px]" title={activeTable}>{activeTable}</span>
            </div>
          ) : (
            <button className="h-10 bg-gradient-to-r from-orange-400 to-red-500 hover:from-orange-500 hover:to-red-600 text-white rounded-xl text-[13px] font-bold transition-all shadow-md flex items-center justify-center px-4 animate-pulse">
              Select Table
            </button>
          )}
        </div>
      ...
      <div className="shrink-0 flex flex-col w-full bg-white shadow-[0_-4px_15px_rgba(0,0,0,0.05)] z-20">
        ...
        <div className="bg-gray-50 flex flex-col relative w-full border-b border-gray-200">
          ...
          {showCharges && (
            <div className="flex flex-col px-4 py-3 space-y-3 text-sm text-gray-700">
              ...
              <div className="flex items-center justify-between font-bold">
                <span className="w-1/3 flex items-center gap-1">Discount <button className="text-primary underline text-[11px] ml-1 hover:text-red-700" onClick={() => setShowDiscountInput(!showDiscountInput)}>More</button></span>
              ...
              <div className="flex items-center justify-between font-bold">
                <span className="w-2/3 flex items-center gap-1"><span className="w-3 h-3 border border-gray-400 bg-gray-100 rounded-full inline-block"></span> Container Charge</span>
                <span className="w-1/3 text-right">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          <div className="flex items-center gap-2">
            <button onClick={handleBogoOffer} className="bg-red-50 text-red-600 px-3 py-1.5 rounded-lg text-xs font-bold border border-red-100 hover:bg-red-100 transition-colors">Bogo Offer</button>
            <button 
              onClick={() => {
        ...
        {/* Row 3: Settlement */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          <span className="text-gray-600 text-[13px] font-bold uppercase tracking-wider">Settlement Amount</span>
          <div className="flex items-center gap-2">
            <input 
              type="number" 
            ...
            <button 
              ...
              className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-4 py-1.5 rounded-lg text-xs font-bold shadow-sm hover:shadow-md transition-all"
            >
              Settle
            </button>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2.5 p-3.5 bg-white border-t border-gray-100">
          <button 
            ...
            className="col-span-1 bg-red-50 text-red-600 py-3.5 rounded-xl text-[14px] font-black tracking-wide hover:bg-red-100 transition-all shadow-sm border border-red-100 disabled:opacity-50"
          >
            SAVE
          </button>
          <button 
            ...
            disabled={loading || cart.length === 0}
            className="col-span-2 bg-gradient-to-r from-red-600 to-orange-500 text-white py-3.5 rounded-xl text-[15px] font-black tracking-wide hover:shadow-lg transition-all shadow-md hover:-translate-y-0.5 disabled:opacity-50"
          >
            SAVE & PRINT
          </button>
          ...
          <button 
            ...
            className="col-span-1 bg-white text-gray-400 border border-gray-200 py-3 rounded-xl text-[13px] font-bold hover:bg-gray-50 hover:text-red-500 transition-all shadow-sm"
          >
            CANCEL
          </button>
        </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <button
                onClick={submitPax}
                className="w-full mt-6 bg-primary text-white font-bold py-3.5 rounded-xl hover:bg-primary-hover active:scale-[0.98] transition-all shadow-md shadow-primary/20"
              >
                Confirm
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              <textarea
                ...
                placeholder="Enter any special requests, allergies, etc."
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
            <div className="p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-gray-800 text-xl mb-2">Changing Tables?</h3>
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                To change or select a table, please use the main <b>Table Selector dropdown</b> located at the top left of the screen.
              </p>
              <button
                onClick={() => setShowTableModal(false)}
                className="w-full bg-gray-100 text-gray-700 font-bold py-3.5 rounded-xl hover:bg-gray-200 active:scale-[0.98] transition-all"
              >
                Got it
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                <label className="block text-gray-500 font-semibold mb-3 text-center">Split equally by how many people?</label>
              ...
              <div className="bg-red-50 border border-red-100 rounded-xl p-5 flex flex-col items-center justify-center text-center">
                <span className="text-red-600/80 font-bold text-xs uppercase tracking-wider mb-1">Each Person Pays</span>
