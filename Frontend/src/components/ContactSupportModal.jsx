...
const ContactSupportModal = ({ isOpen, onClose }) => {const { t } = useLanguage();
      ...
      <div
        ...
        <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-black tracking-tight drop-shadow-md">{t("Support Center")}</h2>
              <p className="text-orange-50 font-medium mt-1 drop-shadow-sm">{t("We're here to help you 24/7")}</p>
            </div>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="p-8">
          <p className="text-slate-600 dark:text-slate-400 mb-8 font-medium">{t("Having trouble with your MS Billing Terminal? Reach out to our dedicated support team using any of the channels below. We ensure a response time of under 30 minutes.")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:shadow-lg hover:border-orange-500/30 transition-all group">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white mb-1">{t("Primary Helpline")}</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-3">{t("Available 24/7 for critical issues")}</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:shadow-lg hover:border-orange-500/30 transition-all group">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white mb-1">{t("Secondary / WhatsApp")}</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-3">{t("For general queries and updates")}</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:shadow-lg hover:border-orange-500/30 transition-all group md:col-span-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white mb-1">{t("Email Support")}</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">{t("Send us detailed logs or feature requests")}</p>
                  <a href="mailto:support@msbillings.com" className="text-lg font-black text-green-500 hover:text-green-600 transition-colors">{t("support@msbillings.com")}
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
            <p className="text-sm font-medium text-slate-400 flex items-center justify-center gap-2">
              <Globe size={16} />{t("MS Tech Hive - Transforming Restaurant Management")}
            </p>
          </div>
        </div>
      </div>
