        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
              <ToggleLeft className="text-primary" /> Menu Item On/Off
            </h1>
            <p className="text-sm text-gray-500">Quickly toggle availability of items to mark them out of stock</p>
          </div>
        </div>
