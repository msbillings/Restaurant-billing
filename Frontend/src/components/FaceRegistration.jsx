...
const FaceRegistration = ({ staff, onSave, onClose }) => {const { t } = useLanguage();
      ...
      <div className="bg-surface p-6 rounded-2xl w-full max-w-md border border-border shadow-2xl">
        ...
        <div className="flex flex-col items-center gap-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white/50">
                  ...
                  <span className="text-sm">{t("Loading AI Models...")}</span>
                </div>
            }
              <video
              ref={videoRef}
          ...
          <button
            onClick={handleSave}
            className="w-full py-3 bg-green-500 text-white rounded-xl font-bold hover:bg-green-600 transition-colors shadow-lg shadow-green-500/20">{t("Save Face Data")}
