  ...
  return (
    <div className="h-full flex flex-col bg-background p-6">
      ...
      <div className="flex justify-between items-center mb-6 p-4 bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl border border-border/50">
        <div>
          <h1 className="text-2xl font-bold text-text-main">{t("Delivery Orders")}</h1>
          <p className="text-text-muted">{t("View and manage delivery orders")}</p>
        </div>
              ...
              <tr>
                  <td colSpan="6" className="p-8 text-center text-text-muted">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-text-main mb-2">{t("No Delivery Orders")}</h3>
