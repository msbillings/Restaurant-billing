...
const PickupOrders = ({ onNavigate, onGoBack }) => {const { t } = useLanguage();
  ...
  const fetchPickupOrders = async () => {
    ...
    try {
      ...
      if (currentPage === 1) {
        ...
        setPagination(paidBills.pagination || { totalBills: allPickupOrders.length, totalPages: 1, currentPage: 1 });
      }
    } catch (error) {
