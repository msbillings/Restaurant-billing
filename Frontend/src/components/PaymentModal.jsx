      ...
      <div className="bg-surface w-full max-w-md rounded-2xl border border-border shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto">
          <div className="text-center mb-8">
            <span className="text-text-muted text-sm uppercase tracking-wider font-semibold">{t("Amount Due")}</span>
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-4 gap-2 mt-2">
                  <button onClick={() => setAmountPaid(total)} className="py-2 bg-surface hover:bg-surface-hover border border-border rounded-lg text-xs font-bold text-text-main transition-colors">{t("Exact")}</button>
              ...
              <div className="flex justify-between items-center p-4 bg-background rounded-xl border border-border">
                <span className="font-medium text-text-muted">{t("Balance to Return")}</span>
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="bg-background p-5 rounded-2xl border border-border flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden">
                  <div className="absolute top-0 left-0 right-0 bg-primary/10 py-1 px-3 text-xs font-bold text-primary tracking-wide uppercase">{t("Scan & Pay Instantly")}
                ...
                <span className="text-primary font-black text-lg">{currencySymbol}{total.toFixed(2)}</span>
