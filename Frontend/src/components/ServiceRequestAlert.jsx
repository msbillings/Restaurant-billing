import { useLanguage } from "../context/LanguageContext";import React, { useEffect, useState, useRef } from 'react';
import axios from '../api/axios';
import { Bell, Droplets, CreditCard, X, Check } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const ServiceRequestAlert = () => {const { t } = useLanguage();
        ...
        <motion.div
          ...
          className="bg-white border-l-4 border-orange-500 shadow-2xl rounded-xl p-4 pointer-events-auto flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-black text-slate-800 text-lg">{t("Table")}{request.tableNumber}</h4>
            ...
            className="bg-green-100 text-green-700 hover:bg-green-500 hover:text-white p-3 rounded-xl transition-colors shadow-sm" title={t("Mark as Done")}>
