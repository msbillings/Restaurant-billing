    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div
        ...
        <div className="pt-16 pb-8 px-8 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mb-8 leading-relaxed">{t("The most advanced point-of-sale and restaurant management ecosystem. Empowering restaurants with Real-time Analytics, AI Face Attendance, and seamless Multi-floor management.")}
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col items-center">
              ...
              <span className="text-xs font-bold text-slate-600 dark:text-slate-300">{t("Enterprise Secure")}</span>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col items-center">
              <Server size={24} className="text-blue-500 mb-2" />
              <span className="text-xs font-bold text-slate-600 dark:text-slate-300">{t("Cloud Sync Ready")}</span>
            </div>
          </div>

          <div className="border-t border-slate-200 dark:border-slate-800 pt-6 mt-2">
            <p className="text-xs text-slate-400 dark:text-slate-500 flex items-center justify-center gap-1 font-medium">{t("Made with")}
              <Heart size={14} className="text-rose-500 fill-rose-500 mx-1" />{t("by")}
              <span className="text-slate-700 dark:text-slate-300 font-bold ml-1">{t("MS Tech Hive")}</span>
            </p>
