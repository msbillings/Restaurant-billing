    ...
    <div className="h-full flex flex-col bg-gray-50 p-6 overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Due Payment (Khata)</h1>
            <p className="text-sm text-gray-500">Manage customer credit accounts and dues</p>
          </div>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="bg-white px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
            <span className="text-sm text-gray-500 font-medium mr-2">Total Outstanding:</span>
          ...
          >
            <UserCheck size={20} /> New Customer Khata
          </button>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <h2 className="text-xl font-bold text-gray-800">New Khata Account</h2>
            ...
            <form onSubmit={handleCreateAccount} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Previous Balance (if any)</label>
                <input 
              ...
              <div className="pt-4 flex gap-3">
                <button type="button" onClick={() => setIsNewAccountModalOpen(false)} className="flex-1 py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl font-medium transition-colors">Cancel</button>
                <button type="submit" className="flex-1 py-3 text-white bg-primary hover:bg-primary-hover rounded-xl font-medium shadow-lg shadow-primary/30 transition-all">Create Account</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div>
                ...
                <p className="text-sm text-gray-500">For {selectedAccount.customerName}</p>
              </div>
            ...
            <form onSubmit={handleAddTransaction} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                <button type="button" onClick={() => setIsTransactionModalOpen(false)} className="flex-1 py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl font-medium transition-colors">Cancel</button>
                <button type="submit" className={`flex-1 py-3 text-white rounded-xl font-medium shadow-lg transition-all ${
                  ...
                  Confirm {transactionFormData.type === 'payment' ? 'Collection' : 'Credit'}
                </button>
              </div>
            </form>
          </div>
